...
// Container defining different general evolutions of the ALICE experiment.
// Each evolution is given a name and a list defining the names of the detectors present.
