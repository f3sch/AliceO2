...
{
 public:
  ITSTPCMatchingQCDevice(std::shared_ptr<DataRequest> dr, std::shared_ptr<o2::base::GRPGeomRequest> req, bool useMC, bool debugHist) : mDataRequest(dr), mCCDBRequest(req), mUseMC(useMC), mDebugHist(debugHist) {}
