...
void customize(std::vector<o2::framework::ConfigParamSpec>& workflowOptions)
{
  ...
  std::vector<o2::framework::ConfigParamSpec> options{
    ...
    {"debug-hist", o2::framework::VariantType::Bool, false, {"enable histogram debugging"}},
...
WorkflowSpec defineDataProcessing(ConfigContext const& configcontext)
{
  ...
  auto debugHist = configcontext.options().get<bool>("debug-hist");

  WorkflowSpec specs;
  specs.emplace_back(getITSTPCMatchingQCDevice(useMC, debugHist));
  return specs;
}
