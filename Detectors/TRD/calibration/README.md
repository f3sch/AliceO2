...
To run the calibration one can start the following workflow:
    ...
    o2-trd-global-tracking -b --disable-root-output --enable-trackbased-calib | o2-calibration-trd-vdrift-exb -b --calib-vdexb-calibration '--tf-per-slot 5 --min-entries-total 50000 --min-entries-chamber 100 --max-delay 90000'
...
If you want to run the calibration from a local file with residuals, trdangreshistos.root, you can run:
    ...
    o2-calibration-trd-vdrift-exb -b --enable-root-input --calib-vdexb-calibration '--tf-per-slot 1 --min-entries-total 50000 --min-entries-chamber 100'
...
This is equivalent to running:
    ...
    o2-calibration-trd-vdrift-exb -b --enable-root-input '--tf-per-slot 1 --min-entries 2000 --min-entries-chamber 0 --enable-root-output'
