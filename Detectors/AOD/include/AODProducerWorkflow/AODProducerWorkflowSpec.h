...
class AODProducerWorkflowDPL : public Task
{
 ...
 private:
  ...
  void fillSecondaryVertices(const o2::globaltracking::RecoContainer& recoData, V0CursorType& v0Cursor, CascadeCursorType& cascadeCursor, Decay3BodyCursorType& decay3BodyCursor, V0TPCCursor& v0tpcCursor);
