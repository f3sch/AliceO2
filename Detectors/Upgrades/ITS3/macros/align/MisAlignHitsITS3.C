...
{
  auto& params = MisAlignParams::Instance();
  params.writeINI("default_parameters_local.ini", "MisAlignParams");
  ...
  params.writeINI("used_parameters_local.ini", "MisAlignParams");
  ...
  for (int iSensor{0}; iSensor < (int)its3c::nSensorsIB; ++iSensor) {
    Euler3D rot{
      params.getValueAs<float>(fmt::format("MisAlignParams.Sensor{}GlobalPhi", iSensor)),
      params.getValueAs<float>(fmt::format("MisAlignParams.Sensor{}GlobalTheta", iSensor)),
      params.getValueAs<float>(fmt::format("MisAlignParams.Sensor{}GlobalPsi", iSensor)),
    };
    Trans3D trans{
      params.getValueAs<float>(fmt::format("MisAlignParams.Sensor{}GlobalDx", iSensor)),
      params.getValueAs<float>(fmt::format("MisAlignParams.Sensor{}GlobalDy", iSensor)),
      params.getValueAs<float>(fmt::format("MisAlignParams.Sensor{}GlobalDz", iSensor)),
    };
