...
class GeometryTGeo final : public o2::detectors::DetMatrixCache
{
 public:
  ...
  [[nodiscard]] unsigned int getLayer(unsigned int index) const noexcept;
  // Get Chip ID from Index in ITS2
  [[nodiscard]] bool getChipIdITS2(unsigned int index, unsigned int lay, unsigned int& hba, unsigned int& sta, unsigned int& hsta, unsigned int& mod, unsigned int& chip) const;
  // Get Chip ID from Index in ITS3
  [[nodiscard]] bool getChipIdITS3(unsigned int index, unsigned int lay, unsigned int& chip, unsigned int& segment, unsigned int& rsu, unsigned int& tile) const;
  // Get Last Chip ID of layer
  [[nodiscard]] unsigned int getLastChipIndex(unsigned int lay) const { return mLastChipIndex[lay]; }
 ...
 private:
  ...
  std::array<unsigned int, constants::nITS2Layers> mITS2NumberOfStaves{};                                              ///< ITS2 number of staves/layer(layer)
  std::array<unsigned int, constants::nITS2Layers> mITS2NumberOfHalfStaves{};                                          ///< ITS2 the number of substaves/stave(layer)
  std::array<unsigned int, constants::nITS2Layers> mITS2NumberOfModules{};                                             ///< ITS2 number of modules/substave(layer)
  std::array<unsigned int, constants::nITS2Layers> mITS2NumberOfChipsPerModule{};                                      ///< ITS2 number of chips per module (group of chips on substaves)
  std::array<unsigned int, constants::nITS2Layers> mITS2NumberOfChipRowsPerModule{};                                   ///< ITS2 number of chips rows per module (relevant for OB modules)
  std::array<unsigned int, constants::nITS2Layers> mITS2NumberOfChipsPerHalfStave{};                                   ///< ITS2 number of chips per substave
  std::array<unsigned int, constants::nITS2Layers> mITS2NumberOfChipsPerStave{};                                       ///< ITS2 number of chips per stave
  std::array<unsigned int, constants::nITS2Layers> mITS2NumberOfChipsPerHalfBarrel{};                                  ///< ITS2 number of chips per halfbarrel
  std::array<unsigned int, constants::nITS2Layers> mITS2NumberOfChipsPerLayer{};                                       ///< ITS2 number of chips per layer
  std::array<unsigned int, constants::nITS3Layers> mITS3NumberOfTilesPerLayer{};                                       ///< ITS3 number of chips/tiles per layer
  std::array<unsigned int, constants::nITS3Layers> mITS3NumberOfTilesPerChip{};                                        ///< ITS3 number of chips/tiles per chip
  std::array<unsigned int, constants::nTotLayers> mLastChipIndex{};                                                    ///< max ID of the detctor in the layer
  ...
  [[nodiscard]] TGeoHMatrix* extractMatrixSensor(unsigned int index) const;
 ...
 public:
  ...
  static const char* getITS3LayerPattern(unsigned int layer = 0) { return Form("%s_%d", getITS3LayerPatternRaw(), layer); };
  static const char* getITS3CarbonFormPatternRaw() { return sCarbonFormNameITS3.c_str(); };
  static const char* getITS3CarbonFormPattern(unsigned int layer = 0) { return Form("%s_%d", getITS3CarbonFormPatternRaw(), layer); };
  static const char* getITS3ChipPatternRaw() { return sChipNameITS3.c_str(); };
  static const char* getITS3ChipPattern(unsigned int layer = 0) { return Form("%s_%d", getITS3ChipPatternRaw(), layer); };
  static const char* getITS3SegmentPatternRaw() { return sSegmentNameITS3.c_str(); };
  static const char* getITS3SegmentPattern(unsigned int layer = 0) { return Form("%s_%d", getITS3SegmentPatternRaw(), layer); };
  static const char* getITS3RSUPatternRaw() { return sRSUNameITS3.c_str(); };
  static const char* getITS3RSUPattern(unsigned int layer = 0) { return Form("%s_%d", getITS3RSUPatternRaw(), layer); };
  static const char* getITS3TilePatternRaw() { return sTileNameITS3.c_str(); };
  static const char* getITS3TilePattern(unsigned int layer = 0) { return Form("%s_%d", getITS3TilePatternRaw(), layer); };
  static const char* getITS3PixelArrayPatternRaw() { return sPixelArrayNameITS3.c_str(); };
  static const char* getITS3PixelArrayPattern(unsigned int layer = 0) { return Form("%s_%d", getITS3PixelArrayPatternRaw(), layer); };
