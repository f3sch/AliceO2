...
function(o2_add_library baseTargetName)
  ...
  cmake_parse_arguments(
    ...
    ""
    "TARGETVARNAME"
    "SOURCES;PUBLIC_INCLUDE_DIRECTORIES;PUBLIC_LINK_LIBRARIES;PRIVATE_INCLUDE_DIRECTORIES;PRIVATE_LINK_LIBRARIES;PUBLIC_LINK_LIBRARIES_UPGRADE"
    )
  ...
  if(A_PUBLIC_LINK_LIBRARIES_UPGRADE AND ENABLE_UPGRADES)
    foreach(L IN LISTS A_PUBLIC_LINK_LIBRARIES_UPGRADE)
      string(FIND ${L} "::" NS)
      if(${NS} EQUAL -1)
        message(FATAL_ERROR "Trying to use a non-namespaced target ${L}")
      endif()
